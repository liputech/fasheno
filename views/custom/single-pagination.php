...
?>
<?php if ( fasheno_option( 'rt_single_navigation_visibility' ) ) { ?>
	...
	<?php if ( $previous ):
		...
		<div class="post-navigation prev">
			<a href="<?php echo esc_url( get_permalink( $previous ) ); ?>" class="nav-title">
				<?php echo fasheno_get_svg( 'arrow-right', '180' ); ?>
				<?php esc_html_e( 'Previous Post: ', 'fasheno' ) ?>
			</a>
	...
	<?php if ( $next ):
		...
		<div class="post-navigation next text-right">
			<a href="<?php echo esc_url( get_permalink( $next ) ); ?>" class="nav-title">
				<?php esc_html_e( 'Next Post: ', 'fasheno' ) ?>
				<?php echo fasheno_get_svg( 'arrow-right' ); ?>
			</a>
