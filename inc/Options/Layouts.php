...
class Layouts {
	...
	public function set_options_value() {
		...
		if ( ( is_single() || is_page() ) ) {
			...
			Opt::$topbar_style     = $this->check_meta_and_layout_value( 'top_bar_style', false, true );
		...
		elseif ( is_home() || is_archive() || is_search() || is_404() ) {
			...
			Opt::$topbar_style     = $this->check_option_value( 'top_bar_style', false, true );
